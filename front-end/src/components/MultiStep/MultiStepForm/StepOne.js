...
const StepOne = (props) => {
	return(
        ...
        <Input placeholder='ชื่อ'/>
			...
			<FormGroup>
				<Input type='textarea' placeholder='ที่อยู่การจัดส่งหลังสือ (กรณีมีหนังสือ)'/>
				<P2 color={color.description}>กรอกที่อยู่ถูกต้อง จะช่วยให้ส่งหนังสือได้เร็วขึ้นจ้า</P2>
			</FormGroup>
			<FormGroup>
				<Row form>
					<Col md={6}>
